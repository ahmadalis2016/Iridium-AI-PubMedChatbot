...
iface = gr.Interface(fn=ask, inputs=gr.Textbox(
    value=""), 
        outputs="markdown",  
        title="Q&A Chatbot Powered by PubMed & Mistral AI ",
        description="Ask a question about BioMedical and get an answer from a friendly AI assistant.",
        examples=[["What are the latest advancements in Alzheimer's disease research?"], 
                ["What is the current understanding of multiple sclerosis?"],
                ["TTell me about the side effects of chemotherapy."]],
